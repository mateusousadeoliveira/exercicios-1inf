# 🚀 PROJETO 3 — ENTRADA NO PARQUE AQUÁTICO

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Parque Aquático Splash.
...
- nome;
- idade;
- categoria (`comum` ou `salva-vidas` ou `coordenador`);
...
Quando o(a) categoria for `salva-vidas` **ou** `coordenador`, o resultado deverá ser:
...
```
Idade: 16 | Possui ingresso: true | Está impedido: false
