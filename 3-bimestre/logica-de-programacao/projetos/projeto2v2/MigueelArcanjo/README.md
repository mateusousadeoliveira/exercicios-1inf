# 🚀 PROJETO 2 (v2) — SISTEMA DE MATRÍCULA EM ACADEMIA

# 🎯 PROBLEMA

Você desenvolve sistemas para a Academia Corpo Ativo.

A academia quer verificar se o aluno atingiu a idade mínima exigida, aplicar desconto para estudantes e conferir o pagamento da matrícula.
...
Situação esperada: Desconto de estudante aplicado
Valor do desconto esperado: R$ 40
```
