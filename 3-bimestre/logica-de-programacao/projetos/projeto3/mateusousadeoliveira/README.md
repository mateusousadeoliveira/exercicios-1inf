# 🚀 PROJETO 3 — LIBERAÇÃO DA AULA DE YOGA

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Aula de Yoga Espaço Zen.
...
```
Idade: 31 | Possui matrícula ativa: true | Está inadimplente: false
