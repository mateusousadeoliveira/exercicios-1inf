# 🚀 PROJETO 2 (v2) — SISTEMA DE MATRÍCULA EM CURSO PRÉ-VESTIBULAR

# 🎯 PROBLEMA

Você desenvolve sistemas para o Curso Pré-Vestibular Aprova Já.
...
```
Aluno: Sabrina Lopes
Turma: Turma Intensiva
Mensalidade: R$ 450
Taxa de material: R$ 80
Frequência (%): 60
Nota de nivelamento: 6
Valor pago: R$ 530
```
...
Resultado esperado: Frequência insuficiente
```
...
```
Matrícula não pode ser confirmada: frequência insuficiente
```
