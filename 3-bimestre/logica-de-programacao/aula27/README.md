...
# 🧩 Segundo desafio rápido

Uma empresa precisa verificar se um funcionário pode acessar uma área restrita.
...
> O funcionário poderá acessar se tiver 18 anos ou mais **e** possuir autorização.

Se a regra for atendida:
