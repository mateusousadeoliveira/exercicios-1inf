# 🚀 PROJETO 3 — ENTRADA NO WORKSHOP

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Workshop de Fotografia.
...
```
Idade: 26 | Possui inscrição: true | Está suspenso: false
...
```
Check-in do workshop confirmado
```

Em qualquer outro caso, o resultado deverá ser:

```
Check-in do workshop não confirmado
```
