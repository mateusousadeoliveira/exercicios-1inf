# 🚀 PROJETO 3 — CONTROLE DE ENTRADA DA SESSÃO IMAX

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Sala IMAX CineMax.
...
```
Idade: 21 | Possui ingresso: true | Está bloqueado: false

Resultado esperado: Entrada na sala liberada
```
