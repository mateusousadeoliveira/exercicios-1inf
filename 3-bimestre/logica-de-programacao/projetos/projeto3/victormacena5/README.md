# 🚀 PROJETO 3 — PORTÃO DO SHOW

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Show de Rock Palco Aberto.
...
```
Acesso ao show liberado
```

Caso contrário:

```
Acesso ao show negado
```

Para o cenário principal:

```
Idade: 17 | Possui ingresso: true | Está impedido: false

Resultado esperado: Acesso ao show negado
```
...
```
Entrada no show confirmada
```

Em qualquer outro caso, o resultado deverá ser:

```
Entrada no show não confirmada
```
