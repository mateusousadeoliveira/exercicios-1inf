# 🚀 PROJETO 3 — LIBERAÇÃO DA AULA DE DANÇA

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Academia de Dança Passo Certo.
...
```
Idade: 19 | Possui matrícula ativa: true | Está inadimplente: false

Resultado esperado: Acesso à aula liberado
```
