# 🚀 PROJETO 3 — LIBERAÇÃO DA SALA DE REUNIÃO

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Coworking Espaço Colaborar.
...
- nome;
- idade;
- categoria (`comum` ou `administrador` ou `coordenador`);
...
Quando o(a) categoria for `administrador` **ou** `coordenador`, o resultado deverá ser:
