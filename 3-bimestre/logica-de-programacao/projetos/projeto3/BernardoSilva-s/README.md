# 🚀 PROJETO 3 — CREDENCIAMENTO DO CONGRESSO

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Congresso Nacional de TI.
...
```
Idade: 30 | Possui inscrição: true | Está bloqueado: false
