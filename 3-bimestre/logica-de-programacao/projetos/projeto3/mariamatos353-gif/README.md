# 🚀 PROJETO 3 — ENTRADA NA FEIRA GASTRONÔMICA

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Feira de Gastronomia Sabor & Arte.
...
- nome;
- idade;
- categoria (`comum` ou `expositor` ou `organizador`);
...
Quando o(a) categoria for `expositor` **ou** `organizador`, o resultado deverá ser:
...
```
Idade: 21 | Possui ingresso: true | Está impedido: false
