# 🚀 PROJETO 3 — CREDENCIAMENTO DA FEIRA DE TECNOLOGIA

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Feira de Tecnologia TechExpo.
...
- nome;
- idade;
- cargo (`comum` ou `expositor` ou `organizador`);
...
```
Idade: 24 | Possui inscrição: true | Está bloqueado: false
