# 🚀 PROJETO 3 — LIBERAÇÃO DO LABORATÓRIO

# 🎯 PROBLEMA

Você faz parte da equipe de desenvolvimento que presta serviços de tecnologia para o Curso Técnico Laboratório de Informática.

Durante a reunião de **Sprint Planning**, a responsável pelo local explicou:

> "Antes de liberar a entrada de um(a) aluno, o sistema precisa verificar várias regras ao mesmo tempo: a idade mínima, se a pessoa possui matrícula ativa, se não está inadimplente e se o pagamento foi realizado. Só depois de checar tudo isso o sistema deve confirmar (ou não) o acesso."
>
...
```
Acesso ao laboratório liberado
```

Caso contrário:

```
Acesso ao laboratório negado
```

Para o cenário principal:

```
Idade: 17 | Possui matrícula ativa: true | Está inadimplente: false

Resultado esperado: Acesso ao laboratório negado
```
